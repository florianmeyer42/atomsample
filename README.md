...
2-5 | Look in the bottom right corner of Atom. After you commited your change, it will show 'Push 1' to indicate that changes need to get pushed to GitHub.  ![Image](newpush.png) The number indicates the number of files that will be pushed to GitHub. Click 'Push' to push the changes.
